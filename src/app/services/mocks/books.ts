...
export const mockBooks: Book [] = [
  { title: 'Angular Up and Running', cover: `${images}/angularjs.jpg`, category: 'Web' },
  ...
  { title: 'Developing an Ionic Edge', cover: `${images}/ionic.jpg`, category: 'Mobile' },
  { title: 'Getting Better in JavaScript', cover: `${images}/javascript.jpg`, category: 'Web' },
  { title: 'JavaScript Robotics', cover: `${images}/robot.jpg`, category: 'IoT' },
  { title: 'Data Visualization with JavaScript', cover: `${images}/datavis.jpg`, category: 'Mobile' },
  { title: 'Learn JavaScript Design Pattern', cover: `${images}/designpattern.jpg`, category: 'Computer Science'},
